...
}`}};function Lt(s){let e=Ot;return s.split("/").forEach(n=>{e&&(e=e[n])}),e}const At=new Re(Lt);function X(s){return At.resolveIncludes(s)}X("background/background.vert"),X("background/background.frag");function H(s){let e="";for(const n in s){const t=s[n];if(typeof t=="boolean")t&&(e+=`#define ${n}
...
`}}return e}X("tileInfo/tileInfo.vert"),X("tileInfo/tileInfo.frag");class Rt extends K{constructor(){super(...arguments),this._color=et(1,0,0,1),this._patternMatrix=tt(),this._programOptions={id:!1,pattern:!1}}dispose(){this._vao&&(this._vao.dispose(),this._vao=null)}drawMany(e,n){const{context:t,painter:i,styleLayerUID:o}=e;this._loadWGLResources(e);const a=e.displayLevel,r=e.styleLayer,l=r.backgroundMaterial,c=i.vectorTilesMaterialManager,f=r.getPaintValue("background-color",a),d=r.getPaintValue("background-opacity",a),_=r.getPaintValue("background-pattern",a),u=_!==void 0,m=f[3]*d,x=1|window.devicePixelRatio,p=e.spriteMosaic;let g,y;const S=x>Ae?2:1,T=e.drawPhase===F.HITTEST,b=this._programOptions;b.id=T,b.pattern=u;const h=c.getMaterialProgram(t,l,b);if(t.bindVAO(this._vao),t.useProgram(h),u){const v=p.getMosaicItemPosition(_,!0);if(A(v)){const{tl:D,br:C,page:I}=v;g=C[0]-D[0],y=C[1]-D[1];const w=p.getPageSize(I);A(w)&&(p.bind(t,9729,I,R),h.setUniform4f("u_tlbr",D[0],D[1],C[0],C[1]),h.setUniform2fv("u_mosaicSize",w),h.setUniform1i("u_texture",R))}h.setUniform1f("u_opacity",d)}else this._color[0]=m*f[0],this._color[1]=m*f[1],this._color[2]=m*f[2],this._color[3]=m,h.setUniform4fv("u_color",this._color);if(h.setUniform1f("u_depth",r.z||0),T){const v=Y(o+1);h.setUniform4fv("u_id",v)}for(const v of n){if(h.setUniform1f("u_coord_range",v.rangeX),h.setUniformMatrix3fv("u_dvsMat3",v.transforms.dvs),u){const D=Math.max(2**(Math.round(a)-v.key.level),1),C=S*v.width*D,I=C/ce(g),w=C/ce(y);this._patternMatrix[0]=I,this._patternMatrix[4]=w,h.setUniformMatrix3fv("u_pattern_matrix",this._patternMatrix)}t.setStencilFunction(514,v.stencilRef,255),t.drawArrays(5,0,4)}}_loadWGLResources(e){if(this._vao)return;const{context:n,styleLayer:t}=e,i=t.backgroundMaterial,o=new Int8Array([0,0,1,0,0,1,1,1]),a=nt.createVertex(n,35044,o),r=new it(n,i.getAttributeLocations(),i.getLayoutInfo(),{geometry:a});this._vao=r}}class Mt extends K{constructor(){super(...arguments),this._programOptions={id:!1}}dispose(){}drawMany(e,n){const{context:t,displayLevel:i,requiredLevel:o,state:a,drawPhase:r,painter:l,spriteMosaic:c,styleLayerUID:f}=e;if(!n.some(b=>{var h,v;return(h=(v=b.layerData.get(f))==null?void 0:v.circleIndexCount)!=null&&h}))return;const d=e.styleLayer,_=d.circleMaterial,u=l.vectorTilesMaterialManager,m=1.2,x=d.getPaintValue("circle-translate",i),p=d.getPaintValue("circle-translate-anchor",i),g=r===F.HITTEST,y=this._programOptions;y.id=g;const S=u.getMaterialProgram(t,_,y);t.useProgram(S),S.setUniformMatrix3fv("u_displayMat3",p===1?a.displayMat3:a.displayViewMat3),S.setUniform2fv("u_circleTranslation",x),S.setUniform1f("u_depth",d.z),S.setUniform1f("u_antialiasingWidth",m);let T=-1;if(g){const b=Y(f+1);S.setUniform4fv("u_id",b)}for(const b of n){if(!b.layerData.has(f))continue;b.key.level!==T&&(T=b.key.level,_.setDataUniforms(S,i,d,T,c));const h=b.layerData.get(f);if(!h.circleIndexCount)continue;h.prepareForRendering(t);const v=h.circleVertexArrayObject;E(v)||(t.bindVAO(v),S.setUniformMatrix3fv("u_dvsMat3",b.transforms.dvs),o!==b.key.level?t.setStencilFunction(514,b.stencilRef,255):t.setStencilFunction(516,255,255),t.drawElements(4,h.circleIndexCount,5125,Uint32Array.BYTES_PER_ELEMENT*h.circleIndexStart),b.triangleCount+=h.circleIndexCount/3)}}}const he=1/65536;class Et extends K{constructor(){super(...arguments),this._fillProgramOptions={id:!1,pattern:!1},this._outlineProgramOptions={id:!1}}dispose(){}drawMany(e,n){const{displayLevel:t,drawPhase:i,renderPass:o,spriteMosaic:a,styleLayerUID:r}=e;let l=!1;for(const b of n)if(b.layerData.has(r)){const h=b.layerData.get(r);if(h.fillIndexCount>0||h.outlineIndexCount>0){l=!0;break}}if(!l)return;const c=e.styleLayer,f=c.getPaintProperty("fill-pattern"),d=f!==void 0,_=d&&f.isDataDriven;let u;if(d&&!_){const b=f.getValue(t);u=a.getMosaicItemPosition(b,!0)}const m=!d&&c.getPaintValue("fill-antialias",t);let x=!0,p=1;if(!d){const b=c.getPaintProperty("fill-color"),h=c.getPaintProperty("fill-opacity");if(!(b!=null&&b.isDataDriven||h!=null&&h.isDataDriven)){const v=c.getPaintValue("fill-color",t);p=c.getPaintValue("fill-opacity",t)*v[3],p>=1&&(x=!1)}}if(x&&o==="opaque")return;let g;i===F.HITTEST&&(g=Y(r+1));const y=c.getPaintValue("fill-translate",t),S=c.getPaintValue("fill-translate-anchor",t);(x||o!=="translucent")&&this._drawFill(e,r,c,n,y,S,d,u,_,g);const T=!c.hasDataDrivenOutlineColor&&c.outlineUsesFillColor&&p<1;m&&o!=="opaque"&&!T&&this._drawOutline(e,r,c,n,y,S,g)}_drawFill(e,n,t,i,o,a,r,l,c,f){if(r&&!c&&E(l))return;const{context:d,displayLevel:_,state:u,drawPhase:m,painter:x,pixelRatio:p,spriteMosaic:g}=e,y=t.fillMaterial,S=x.vectorTilesMaterialManager,T=p>Ae?2:1,b=m===F.HITTEST,h=this._fillProgramOptions;h.id=b,h.pattern=r;const v=S.getMaterialProgram(d,y,h);if(d.useProgram(v),A(l)){const{page:C}=l,I=g.getPageSize(C);A(I)&&(g.bind(d,9729,C,R),v.setUniform2fv("u_mosaicSize",I),v.setUniform1i("u_texture",R))}v.setUniformMatrix3fv("u_displayMat3",a===1?u.displayMat3:u.displayViewMat3),v.setUniform2fv("u_fillTranslation",o),v.setUniform1f("u_depth",t.z+he),b&&v.setUniform4fv("u_id",f);let D=-1;for(const C of i){if(!C.layerData.has(n))continue;C.key.level!==D&&(D=C.key.level,y.setDataUniforms(v,_,t,D,g));const I=C.layerData.get(n);if(!I.fillIndexCount)continue;I.prepareForRendering(d);const w=I.fillVertexArrayObject;if(!E(w)){if(d.bindVAO(w),v.setUniformMatrix3fv("u_dvsMat3",C.transforms.dvs),d.setStencilFunction(514,C.stencilRef,255),r){const O=Math.max(2**(Math.round(_)-C.key.level),1),P=C.rangeX/(T*C.width*O);v.setUniform1f("u_patternFactor",P)}if(c){const O=I.patternMap;if(!O)continue;for(const[P,U]of O){const k=g.getPageSize(P);A(k)&&(g.bind(d,9729,P,R),v.setUniform2fv("u_mosaicSize",k),v.setUniform1i("u_texture",R),d.drawElements(4,U[1],5125,Uint32Array.BYTES_PER_ELEMENT*U[0]))}}else d.drawElements(4,I.fillIndexCount,5125,Uint32Array.BYTES_PER_ELEMENT*I.fillIndexStart);C.triangleCount+=I.fillIndexCount/3}}}_drawOutline(e,n,t,i,o,a,r){const{context:l,displayLevel:c,state:f,drawPhase:d,painter:_,pixelRatio:u,spriteMosaic:m}=e,x=t.outlineMaterial,p=_.vectorTilesMaterialManager,g=.75/u,y=d===F.HITTEST,S=this._outlineProgramOptions;S.id=y;const T=p.getMaterialProgram(l,x,S);l.useProgram(T),T.setUniformMatrix3fv("u_displayMat3",a===1?f.displayMat3:f.displayViewMat3),T.setUniform2fv("u_fillTranslation",o),T.setUniform1f("u_depth",t.z+he),T.setUniform1f("u_outline_width",g),y&&T.setUniform4fv("u_id",r);let b=-1;for(const h of i){if(!h.layerData.has(n))continue;h.key.level!==b&&(b=h.key.level,x.setDataUniforms(T,c,t,b,m));const v=h.layerData.get(n);if(v.prepareForRendering(l),!v.outlineIndexCount)continue;const D=v.outlineVertexArrayObject;E(D)||(l.bindVAO(D),T.setUniformMatrix3fv("u_dvsMat3",h.transforms.dvs),l.setStencilFunction(514,h.stencilRef,255),l.drawElements(4,v.outlineIndexCount,5125,Uint32Array.BYTES_PER_ELEMENT*v.outlineIndexStart),h.triangleCount+=v.outlineIndexCount/3)}}}class Vt extends K{constructor(){super(...arguments),this._programOptions={id:!1,pattern:!1,sdf:!1}}dispose(){}drawMany(e,n){const{context:t,displayLevel:i,state:o,drawPhase:a,painter:r,pixelRatio:l,spriteMosaic:c,styleLayerUID:f}=e;if(!n.some(w=>{var O,P;return(O=(P=w.layerData.get(f))==null?void 0:P.lineIndexCount)!=null&&O}))return;const d=e.styleLayer,_=d.lineMaterial,u=r.vectorTilesMaterialManager,m=d.getPaintValue("line-translate",i),x=d.getPaintValue("line-translate-anchor",i),p=d.getPaintProperty("line-pattern"),g=p!==void 0,y=g&&p.isDataDriven;let S,T;if(g&&!y){const w=p.getValue(i);S=c.getMosaicItemPosition(w)}let b=!1;if(!g){const w=d.getPaintProperty("line-dasharray");if(T=w!==void 0,b=T&&w.isDataDriven,T&&!b){const O=w.getValue(i),P=d.getDashKey(O,d.getLayoutValue("line-cap",i));S=c.getMosaicItemPosition(P)}}const h=1/l,v=a===F.HITTEST,D=this._programOptions;D.id=v,D.pattern=g,D.sdf=T;const C=u.getMaterialProgram(t,_,D);if(t.useProgram(C),C.setUniformMatrix3fv("u_displayViewMat3",o.displayViewMat3),C.setUniformMatrix3fv("u_displayMat3",x===1?o.displayMat3:o.displayViewMat3),C.setUniform2fv("u_lineTranslation",m),C.setUniform1f("u_depth",d.z),C.setUniform1f("u_antialiasing",h),v){const w=Y(f+1);C.setUniform4fv("u_id",w)}if(S&&A(S)){const{page:w}=S,O=c.getPageSize(w);A(O)&&(c.bind(t,9729,w,R),C.setUniform2fv("u_mosaicSize",O),C.setUniform1i("u_texture",R))}let I=-1;for(const w of n){if(!w.layerData.has(f))continue;w.key.level!==I&&(I=w.key.level,_.setDataUniforms(C,i,d,I,c));const O=2**(i-I)/l;C.setUniform1f("u_zoomFactor",O);const P=w.layerData.get(f);if(!P.lineIndexCount)continue;P.prepareForRendering(t);const U=P.lineVertexArrayObject;if(!E(U)){if(t.bindVAO(U),C.setUniformMatrix3fv("u_dvsMat3",w.transforms.dvs),t.setStencilFunction(514,w.stencilRef,255),y||b){const k=P.patternMap;if(!k)continue;for(const[G,z]of k){const W=c.getPageSize(G);A(W)&&(c.bind(t,9729,G,R),C.setUniform2fv("u_mosaicSize",W),C.setUniform1i("u_texture",R),t.drawElements(4,z[1],5125,Uint32Array.BYTES_PER_ELEMENT*z[0]))}}else t.drawElements(4,P.lineIndexCount,5125,Uint32Array.BYTES_PER_ELEMENT*P.lineIndexStart);w.triangleCount+=P.lineIndexCount/3}}}}const Ft=1/65536;class Nt extends K{constructor(){super(...arguments),this._iconProgramOptions={id:!1,sdf:!1},this._sdfProgramOptions={id:!1},this._spritesTextureSize=ot()}dispose(){}drawMany(e,n){const{drawPhase:t,styleLayerUID:i}=e,o=e.styleLayer;let a;t===F.HITTEST&&(a=Y(i+1)),this._drawIcons(e,o,n,a),this._drawText(e,o,n,a)}_drawIcons(e,n,t,i){const{context:o,displayLevel:a,drawPhase:r,painter:l,spriteMosaic:c,state:f,styleLayerUID:d}=e,_=n.iconMaterial,u=l.vectorTilesMaterialManager;let m,x=!1;for(const I of t)if(I.layerData.has(d)&&(m=I.layerData.get(d),m.iconPerPageElementsMap.size>0)){x=!0;break}if(!x)return;const p=n.getPaintValue("icon-translate",a),g=n.getPaintValue("icon-translate-anchor",a);let y=n.getLayoutValue("icon-rotation-alignment",a);y===2&&(y=n.getLayoutValue("symbol-placement",a)===0?1:0);const S=y===0,T=n.getLayoutValue("icon-keep-upright",a)&&S,b=m.isIconSDF,h=r===F.HITTEST,v=this._iconProgramOptions;v.id=h,v.sdf=b;const D=u.getMaterialProgram(o,_,v);o.useProgram(D),D.setUniformMatrix3fv("u_displayViewMat3",y===0?f.displayViewMat3:f.displayMat3),D.setUniformMatrix3fv("u_displayMat3",g===1?f.displayMat3:f.displayViewMat3),D.setUniform2fv("u_iconTranslation",p),D.setUniform1f("u_depth",n.z),D.setUniform1f("u_mapRotation",fe(f.rotation)),D.setUniform1f("u_keepUpright",T?1:0),D.setUniform1f("u_level",10*a),D.setUniform1i("u_texture",R),D.setUniform1f("u_fadeDuration",te/1e3),h&&D.setUniform4fv("u_id",i);let C=-1;for(const I of t){if(!I.layerData.has(d)||(I.key.level!==C&&(C=I.key.level,_.setDataUniforms(D,a,n,C,c)),m=I.layerData.get(d),m.iconPerPageElementsMap.size===0))continue;m.prepareForRendering(o),m.updateOpacityInfo();const w=m.iconVertexArrayObject;if(!E(w)){o.bindVAO(w),D.setUniformMatrix3fv("u_dvsMat3",I.transforms.dvs),D.setUniform1f("u_time",(performance.now()-m.lastOpacityUpdate)/1e3);for(const[O,P]of m.iconPerPageElementsMap)this._renderIconRange(e,D,P,O,I)}}}_renderIconRange(e,n,t,i,o){const{context:a,spriteMosaic:r}=e;this._spritesTextureSize[0]=r.getWidth(i)/4,this._spritesTextureSize[1]=r.getHeight(i)/4,n.setUniform2fv("u_mosaicSize",this._spritesTextureSize),r.bind(a,9729,i,R),a.setStencilTestEnabled(!0),a.setStencilFunction(516,255,255),a.setStencilWriteMask(0),a.drawElements(4,t[1],5125,Uint32Array.BYTES_PER_ELEMENT*t[0]),o.triangleCount+=t[1]/3}_drawText(e,n,t,i){const{context:o,displayLevel:a,drawPhase:r,glyphMosaic:l,painter:c,pixelRatio:f,spriteMosaic:d,state:_,styleLayerUID:u}=e,m=n.textMaterial,x=c.vectorTilesMaterialManager;let p,g=!1;for(const V of t)if(V.layerData.has(u)&&(p=V.layerData.get(u),p.glyphPerPageElementsMap.size>0)){g=!0;break}if(!g)return;const y=n.getPaintProperty("text-opacity");if(y&&!y.isDataDriven&&y.getValue(a)===0)return;const S=n.getPaintProperty("text-color"),T=!S||S.isDataDriven||S.getValue(a)[3]>0,b=n.getPaintProperty("text-halo-width"),h=n.getPaintProperty("text-halo-color"),v=(!b||b.isDataDriven||b.getValue(a)>0)&&(!h||h.isDataDriven||h.getValue(a)[3]>0);if(!T&&!v)return;const D=24/8;let C=n.getLayoutValue("text-rotation-alignment",a);C===2&&(C=n.getLayoutValue("symbol-placement",a)===0?1:0);const I=C===0,w=n.getLayoutValue("text-keep-upright",a)&&I,O=r===F.HITTEST,P=.8*D/f;this._glyphTextureSize||(this._glyphTextureSize=at(l.width/4,l.height/4));const U=n.getPaintValue("text-translate",a),k=n.getPaintValue("text-translate-anchor",a),G=this._sdfProgramOptions;G.id=O;const z=x.getMaterialProgram(o,m,G);o.useProgram(z),z.setUniformMatrix3fv("u_displayViewMat3",C===0?_.displayViewMat3:_.displayMat3),z.setUniformMatrix3fv("u_displayMat3",k===1?_.displayMat3:_.displayViewMat3),z.setUniform2fv("u_textTranslation",U),z.setUniform1f("u_depth",n.z+Ft),z.setUniform2fv("u_mosaicSize",this._glyphTextureSize),z.setUniform1f("u_mapRotation",fe(_.rotation)),z.setUniform1f("u_keepUpright",w?1:0),z.setUniform1f("u_level",10*a),z.setUniform1i("u_texture",de),z.setUniform1f("u_antialiasingWidth",P),z.setUniform1f("u_fadeDuration",te/1e3),O&&z.setUniform4fv("u_id",i);let W=-1;for(const V of t){if(!V.layerData.has(u)||(V.key.level!==W&&(W=V.key.level,m.setDataUniforms(z,a,n,W,d)),p=V.layerData.get(u),p.glyphPerPageElementsMap.size===0))continue;p.prepareForRendering(o),p.updateOpacityInfo();const ne=p.textVertexArrayObject;if(E(ne))continue;o.bindVAO(ne),z.setUniformMatrix3fv("u_dvsMat3",V.transforms.dvs),o.setStencilTestEnabled(!0),o.setStencilFunction(516,255,255),o.setStencilWriteMask(0);const Me=(performance.now()-p.lastOpacityUpdate)/1e3;z.setUniform1f("u_time",Me),p.glyphPerPageElementsMap.forEach((Ee,Ve)=>{this._renderGlyphRange(o,Ee,Ve,l,z,v,T,V)})}}_renderGlyphRange(e,n,t,i,o,a,r,l){i.bind(e,9729,t,de),a&&(o.setUniform1f("u_halo",1),e.drawElements(4,n[1],5125,Uint32Array.BYTES_PER_ELEMENT*n[0]),l.triangleCount+=n[1]/3),r&&(o.setUniform1f("u_halo",0),e.drawElements(4,n[1],5125,Uint32Array.BYTES_PER_ELEMENT*n[0]),l.triangleCount+=n[1]/3)}}const Ut={vtlBackground:Rt,vtlFill:Et,vtlLine:Vt,vtlCircle:Mt,vtlSymbol:Nt},kt={background:{"background.frag":`#ifdef PATTERN
uniform lowp float u_opacity;
uniform lowp sampler2D u_texture;
varying mediump vec4 v_tlbr;
varying mediump vec2 v_tileTextureCoord;
...
}`}};function Ht(s){let e=kt;return s.split("/").forEach(n=>{e&&(e=e[n])}),e}const Wt=new Re(Ht);function L(s){return Wt.resolveIncludes(s)}const xe=s=>H({ID:s.id,PATTERN:s.pattern}),Bt={shaders:s=>({vertexShader:xe(s)+L("background/background.vert"),fragmentShader:xe(s)+L("background/background.frag")})},ye=s=>H({ID:s.id}),Gt={shaders:s=>({vertexShader:ye(s)+L("circle/circle.vert"),fragmentShader:ye(s)+L("circle/circle.frag")})},be=s=>H({ID:s.id,PATTERN:s.pattern}),$t={shaders:s=>({vertexShader:be(s)+L("fill/fill.vert"),fragmentShader:be(s)+L("fill/fill.frag")})},Se=s=>H({ID:s.id}),qt={shaders:s=>({vertexShader:Se(s)+L("outline/outline.vert"),fragmentShader:Se(s)+L("outline/outline.frag")})},Ce=s=>H({ID:s.id,SDF:s.sdf}),Zt={shaders:s=>({vertexShader:Ce(s)+L("icon/icon.vert"),fragmentShader:Ce(s)+L("icon/icon.frag")})},Te=s=>H({ID:s.id,PATTERN:s.pattern,SDF:s.sdf}),Yt={shaders:s=>({vertexShader:Te(s)+L("line/line.vert"),fragmentShader:Te(s)+L("line/line.frag")})},De=s=>H({ID:s.id}),Kt={shaders:s=>({vertexShader:De(s)+L("text/text.vert"),fragmentShader:De(s)+L("text/text.frag")})};class jt{constructor(){this._programByKey=new Map}dispose(){this._programByKey.forEach(e=>e.dispose()),this._programByKey.clear()}getMaterialProgram(e,n,t){const i=n.key<<3|this._getMaterialOptionsValue(n.type,t);if(this._programByKey.has(i))return this._programByKey.get(i);const o=this._getProgramTemplate(n.type),{shaders:a}=o,{vertexShader:r,fragmentShader:l}=a(t),c=n.getShaderHeader(),f=n.getShaderMain(),d=r.replace("#pragma header",c).replace("#pragma main",f),_=new rt(e,d,l,n.getAttributeLocations());return this._programByKey.set(i,_),_}_getMaterialOptionsValue(e,n){switch(e){case 0:{const t=n;return(t.pattern?1:0)<<1|(t.id?1:0)}case 1:{const t=n;return(t.pattern?1:0)<<1|(t.id?1:0)}case 2:return n.id?1:0;case 3:{const t=n;return(t.sdf?1:0)<<2|(t.pattern?1:0)<<1|(t.id?1:0)}case 4:{const t=n;return(t.sdf?1:0)<<1|(t.id?1:0)}case 5:return n.id?1:0;case 6:return n.id?1:0;default:return 0}}_getProgramTemplate(e){switch(e){case 0:return Bt;case 5:return Gt;case 1:return $t;case 4:return Zt;case 3:return Yt;case 2:return qt;case 6:return Kt;default:return null}}}const we=1e-6;class Ie{constructor(e,n){this.spriteMosaic=e,this.glyphMosaic=n,this._brushCache=new Map,this._vtlMaterialManager=new jt}dispose(){this._brushCache&&(this._brushCache.forEach(e=>e.dispose()),this._brushCache=null),this._vtlMaterialManager=Le(this._vtlMaterialManager),this.spriteMosaic.dispose(),this.glyphMosaic.dispose()}get vectorTilesMaterialManager(){return this._vtlMaterialManager}drawTile(e,n,t){const{context:i}=e,o=t.layers;t.backgroundBucketIds.length>0&&(e.renderPass="background",t.backgroundBucketIds.forEach(a=>this._renderStyleLayer(t.getLayerById(a),e,n,!0))),i.setBlendingEnabled(!1),i.setDepthTestEnabled(!0),i.setDepthWriteEnabled(!0),i.setDepthFunction(515),e.renderPass="opaque";for(let a=o.length-1;a>=0;a--)this._renderStyleLayer(o[a],e,n,!1);i.setDepthWriteEnabled(!1),i.setBlendingEnabled(!0),i.setBlendFunctionSeparate(1,771,1,771),e.renderPass="translucent";for(let a=0;a<o.length;a++)this._renderStyleLayer(o[a],e,n,!1);i.setDepthTestEnabled(!1),e.renderPass="symbol";for(let a=0;a<o.length;a++)this._renderStyleLayer(o[a],e,n,!1);i.bindVAO()}_renderStyleLayer(e,n,t,i=!1){if(!(i||e&&t.layerData.has(e.uid)))return;const o=e.getLayoutProperty("visibility");if(o&&o.getValue()===1)return;const{renderPass:a}=n;let r;switch(e.type){case 0:if(a!=="background")return;r="vtlBackground";break;case 1:if(a!=="opaque"&&n.renderPass!=="translucent")return;r="vtlFill";break;case 2:if(a!=="translucent")return;r="vtlLine";break;case 4:if(a!=="symbol")return;r="vtlCircle";break;case 3:if(a!=="symbol")return;r="vtlSymbol"}const l=n.displayLevel;e.minzoom!==void 0&&e.minzoom>l+we||e.maxzoom!==void 0&&e.maxzoom<=l-we||(n.styleLayerUID=e.uid,n.styleLayer=e,this.drawWithBrush(n,t,r))}drawWithBrush(e,n,t){if(!this._brushCache.has(t)){const i=Ut[t];this._brushCache.set(t,new i)}this._brushCache.get(t).drawMany(e,[n])}}let N=class extends lt(st(ct)){constructor(){super(...arguments),this.type="vector-tile-3d"}initialize(){if(E(this.layer.fullExtent))return void this.addResolvingPromise(Promise.reject(new ut("vectortilelayerview:full-extent-undefined","This layer view's layer does not define a fullExtent.")));const s=this.layer.compatibleTileInfo256,e=this._getTileInfoSupportError(s,this.layer.fullExtent);if(e)return this.addResolvingPromise(Promise.reject(e));const{basemapTerrain:n,spatialReference:t,pixelRatio:i}=this.view,o=ft(this.view,"basemapTerrain.tilingSchemeLocked").then(()=>{const p=n.tilingScheme,g=p.pixelSize;let y;this.schemaHelper=new mt(g,t.isGeographic),y=g===256?this.layer.compatibleTileInfo256:this.view.spatialReference.isGeographic?this.layer.compatibleTileInfo512:this.layer.tileInfo;const S=this._getTileInfoCompatibilityError(y,p);if(S)throw S;this._set("tileInfo",y)});this._tileHandlerController=new AbortController;const a=this.view.resourceController;this._memCache=a.memoryController.newCache(this.layer.uid,p=>{p.release()});const{style:r}=this.layer.currentStyleInfo,l=new _e(r),c=n.mapTileRequester;this._tileHandler=new ge(this.layer,l,i,this._memCache,c);const f=this._tileHandlerController.signal,d=p=>a.schedule(p),_=this._tileHandler.start({signal:f,schedule:d}),u=this._tileHandler.spriteMosaic;u.then(p=>{!dt(f)&&this._tileHandler&&(this.painter=new Ie(p,this._tileHandler.glyphMosaic))}),_.then(()=>this._tileHandlerController=null);const m=()=>{this._tileHandlerController&&this._tileHandlerController.abort(),this._tileHandlerController=new AbortController,this._memCache.clear();const{style:p}=this.layer.currentStyleInfo,g=new _e(p),y=new ge(this.layer,g,i,this._memCache,c),S=y.start({signal:this._tileHandlerController.signal,schedule:d}),T=y.spriteMosaic;S.then(()=>this._tileHandlerController=null),this.updatingHandles.addPromise(Promise.all([S,T]).then(([,b])=>{const h=this._tileHandler,v=this.painter;this.painter=new Ie(b,y.glyphMosaic),this._tileHandler=y,this.emit("data-changed"),h.destroy(),v&&v.dispose()}))};this.updatingHandles.add(this,"layer.currentStyleInfo",m),this.updatingHandles.add(this,"view.pixelRatio",m);const x=Promise.all([o,_,u]);this.addResolvingPromise(x)}destroy(){this.painter=Le(this.painter),this._tileHandlerController&&(this._tileHandlerController.abort(),this._tileHandlerController=null),ue(this._tileHandler),this._memCache=ue(this._memCache),this._tileHandler=null}get dataLevelRange(){const s=this.tileInfo.lods,e=s[0].scale,n=s[s.length-1].scale,t=this.levelRangeFromScaleRange(e,n);return t.minLevel===1&&this.tileInfo.size[0]===256&&(t.minLevel=0),t}async fetchTile(s,e,n,t){return this._tileHandler.getVectorTile(s,e,n,t)}};B([q({aliasOf:"layer.fullExtent"})],N.prototype,"fullExtent",void 0),B([q()],N.prototype,"layer",void 0),B([q()],N.prototype,"tileInfo",void 0),B([q()],N.prototype,"dataLevelRange",null),B([q()],N.prototype,"updatingProgressValue",void 0),N=B([_t("esri.views.3d.layers.VectorTileLayerView3D")],N);const fn=N;export{fn as default};
